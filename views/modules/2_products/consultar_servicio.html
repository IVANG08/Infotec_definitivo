                 ...
                 <div class="card" style="width: 60rem;">
                    ...
                    <ul class=" list-group list-group-flush">
                        <li class=" buscar list-group-item">
                            <div class="mb-3 ">     
                                <label for="validationCustom02" class="">Nombre Servicio</label>
                    ...
                    <table class="table col-11">
                        ...
                        <tbody>
                            <tr class="text-center">
                                <th scope="row">1</th>
                                <td>Engrase Cadena</td>
                                <td>7000</td>
                                                              
                                <td class="text-center"><a class="btn btn-warning" href="actualizar_servicio.html"><i class="bi bi-pencil-square"></i></a></td>
                                <td  class="text-center"><a class="btn btn-danger" href=""><i class="fa fa-trash"></i></a></td>
                            </tr>
                            <tr class="text-center">
                                <th scope="row">2</th>
                                <td>Cambio kit arrastre</td>
                                <td>25000</td>
