    ...
    <script>
        function getVehi(){
                ...
                let select = $("#id_vehiculo");
                    fetch('http://localhost:8081/infotec_definitivo/?c=Factura&a=vehiculocliente&id='+ cliente)
        ...
        function getPOS(id) {
            console.log($(this))
                ...
                if (tipo == 'servicio') {
                    ...
                    fetch('http://localhost:8081/infotec_definitivo/?c=Listaproducto&a=busquedaproducto')
                        .then(response => response.json())
                        .then(data => {
                            let opciones = '<option selected>Elija </option>'
                            data.forEach(function (item) {
        ...
        function getValor(id) {
            ...
            if (tipo == 'servicio') {
                ...
                fetch('http://localhost:8081/infotec_definitivo/?c=Listaproducto&a=precioProducto&id=' + idpos)
                    .then(response => response.json())
                    .then(data => {
                        $("#valor_" + id).val(data)
                        getTotal(id)
