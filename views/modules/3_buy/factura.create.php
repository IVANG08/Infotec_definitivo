    ...
    <div class="row">
        <div class="col-md-12 ">
            ...
            <div class="div col-md-12">
                <form method="post" action="?c=Factura&a=crear_factura" class="needs-validation" id="factura"
                    novalidate>
                    <div class="col-md-3 ">
                        ...
                        <div> <label class="tituloFac col-md-">Usuario: </label> <select class="form-control "
                                name="id_usuario" placeholder="usuario" id="id_usuario">
                                ...
                                foreach ($verUsuario as $usuario) {
                                    ...
                                    <option value='<?php echo $usuario['id_usuario'] ?>'>
                                        ...
                                        echo " ";
                                        echo $usuario['apellidos_usuario'] ?>
                                    </option>
                                    <?php
                                }
                                ?>
                        ...
                        <div>
                            <label class="tituloFac col-md-">Cliente: </label> <select class="form-control "
                                name="id_cliente" placeholder="Cliente" id="id_cliente" onchange="getVehi()">
                        ...
                        <div>
                            <label class="tituloFac col-md-">Placa Vehiculo: </label><select class="form-control "
                                name="id_vehiculo" placeholder="Vehiculo" id="id_vehiculo">
                                <option selected> Elija vehiculo</option>
                            </select>
                        </div>
                        <div>
                            <input type="text" class="form-control" name="cant_ids" id="cant_ids" value=1 readonly
                                hidden>
                        </div>
                        <div>
                            <label class="tituloFac col-md-">Total: </label><input type="text" class="form-control"
                                name="total_pedido" id="total_pedido" placeholder="Total" readonly>
                        </div>
                        <divs class="tamaño2">
                    ...
                    <div class="div col-md-9">
                        <div class="tamaño2">
                            <td class="text-center">
                                <a class="btn-otro2 btn-secondary" id="agregar"
                            ...
                            <table id="tablafactura" class="table justify-content-center  table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <select class="form-control tipo" name="tipo_1" id='tipo_1'
                                                onchange="getPOS(1)" placeholder="Elija">
                                        ...
                                        <td class="text-center">
                                            <select class="form-control pos" name="pos_1" id='pos_1'
                                                onchange="getValor(1)" placeholder="Elija">
                                                <option selected>Elija </option>
                                            </select>
                                        </td>
                                        <td class="text-center">
                                            <input type="text" class="form-control cantidad" name="cantidad_1"
                                                onchange="getTotal(1)" id="cantidad_1" value=1>
                                            <input hidden type="text" class="form-control" name="max_cantidad_1"
                                                id="max_cantidad_1" value=0>
                                        </td>
                                        <td class="text-center">
                                            <input type="text" class="form-control valor" name="valor_1" id="valor_1"
                                                readonly>
                                        </td>
                                        <td class="text-center">
                                            <input type="text" class="form-control" name="total_1" id="total_1" value=0
                                                readonly>
                                        </td>
                                    </tr>
                                </tbody>
...
<script>
    ...
    function getValor(id) {
        ...
        if (tipo == 'servicio') {
            ...
            fetch('http://localhost/Infotec_definitivo/?c=Listaproducto&a=precioProducto&id=' + idpos)
                ...
                .then(data => {
                    console.log(data)
                    $("#valor_" + id).val(data.precio_producto)
                    $("#max_cantidad_" + id).val(data.exist_producto)
                    getTotal(id)
                });
        }
    }
    function getTotal(id) {
        ...
        if (tipo == 'producto' && (Number($("#max_cantidad_" + id).val()) < Number($("#cantidad_" + id).val()))) {
            $("#cantidad_" + id).val(0)
            alert("La cantidad seleccionada es mayor que el inventario ")
        }
    ...
    function agregarCampo() {
        ...
        <input hidden type="text" class="form-control" name="max_cantidad_${nId}"  id="max_cantidad_${nId}" value =0>
        </td>`);
        nuevaFila.append(`<td class="text-center"> 
